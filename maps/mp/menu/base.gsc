...
//////////////////////////////////////////////////////////////////////////////////
//ҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժ
//ҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժ
//ҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժ
//ҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժ
////////////////--- WHITE NOISE V2 BY @K3Y3D - RELEASE X/X/X ---//////////////////
//ҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժ
//ҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժ
//ҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժ
//ҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժҟӠվӠժ
//////////////////////////////////////////////////////////////////////////////////
///////base menu is sageis blue lobster and edited to be better//////////////////
...
onspawn()
{
    for(;;)
    {
		...
		self setClientDvar("player_useRadius", "900"); 
        setDvarIfUni("function_savepoint",1);
        setdvarifuni("function_spawnsavepoint",1);
        self loadposspawn();
        setdvarifuni("function_camoindex",0);
      ...
      // setDvar("function_brax", 0);
       ...
       // self setPlayerData( "experience", 2434700 );
        ...
        if(!isDefined(self.hasspawn))
        {
            ...
            self iPrintLn("Welcome to ^0[" + self.menutitle + "^0]");
            self iPrintLn("^0[[{+speed_throw}]^0] + [^:[{+actionslot 2}]^0] To open menu");
            self.menuopen = false;
...
{
    self.menucolor = (0.30,0.30,0.30);
    //self.menucolor2 = (0,.65,1);
        self.menucolor2 = (0.3,.3,.3);
}

changecolor()
{
    self.menucolor2 = (0,.5,1);

    self.menu_bg[self.name][1] fadeOverTime(0.25);
...
open_menu()
{
    ...
    setDvar("sv_padpackets",0);
    self.menu_title[self.name] fadeOverTime(0.62);
    self.menu_title[self.name].alpha = 1;

    self.menu_sub[self.name] fadeOverTime(0.42);
    self.menu_sub[self.name].alpha = 0.8;

    self.menu_bg[self.name][0] fadeOverTime(0.42);
    self.menu_bg[self.name][0].alpha = 0.7;

    self.menu_bg[self.name][1] fadeOverTime(0.42);
    self.menu_bg[self.name][1].alpha = 0.4;


    self.menu_pos[self.name] fadeOverTime(0.42);
    self.menu_pos[self.name].alpha = 1;

    self.menu_time[self.name] fadeOverTime(0.42);
    self.menu_time[self.name].alpha = 0.8;
    ...
    if(self.options > 10)
    opt = 10;
    self.menu_bg[self.name][0] scaleOverTime(0.25, 150, 35 + (14 * opt));
    self.menu_bg[self.name][1] scaleOverTime(0.25, 150, 35 + (14 * opt));
    ...
    {
        self.menu_outline[self.name][i] fadeOverTime(0.2);
        self.menu_outline[self.name][i].alpha = 2;
    }
...
{          //createText(text, font, fontScale, align, x, y, color, alpha, sort)
    self.basedrawn = 1;
    self colormenu(); 
    self.menu_bg[self.name][0] = self createRectangle("TOP", 230, -105, 10, 1, (0,0,0), "black", 1.5, 1); 
    self.menu_bg[self.name][1] = self createRectangle("TOP", 230, -105, 10, 1, self.menucolor, "gradient_fadein_fadebottom", 1, 1); 
    //menu title createRectangle
    self.menu_outline[self.name][0] = self createRectangle("TOP", 230, -105, 150, 20, self.menucolor, "black", 1, 1);

    // entire menu options
    for(i = 0 ; i < 10 ; i++)
    self.menu_text[self.name][i] = self createText("Test + " + i, "bold", .8, "LEFT", 159, -76 + (15 * i), (1,1,1), 1, 3);

    ///////////////sub menu title like main menu
    //////////////self.menu_sub[self.name] = self createText(self.currentsub, "default", 1, "RIGHT", 298, -88, "white", 2, 3);
    
    //////////////menu_time
    /////////////self.menu_time[self.name] = self createText(getDvarInt("menutime_hour") + ":" + getDvarInt("menutime_min") + ":" + getDvarInt("menutime_sec"), "default", 0.8, "CENTER", 106, -83, "white", 2, 3);
    
    //menu position indicator
    self.menu_pos[self.name] = self createText(self.origin, "consolefont", 0.55, "RIGHT", 300, -79, "white", 1, 3);
    
    //menu title 
    self.menu_title[self.name] = self createText(self.menutitle, "bold", 1.25, "CENTER", 230, -95, (1,1,1), 1, 3);
...
updatemenu()
{
    ...
    if(self.options <= 10)
    {
        ...
        {
            self.menu_text[self.name][0].color = self.menucolor2;
            for(i = 0 ; i < 10 ; i++)
        ...
        {
            self.menu_text[self.name][1].color = self.menucolor2;
            for(i = 0 ; i < 10 ; i++)
            self.menu_text[self.name][i] setSafeText(self.opt[i]);
        }
        ...
        {
            self.menu_text[self.name][2].color = self.menucolor2;
            for(i = 0 ; i < 10 ; i++)
            self.menu_text[self.name][i] setSafeText(self.opt[i]);
        }
        ...
        {
            self.menu_text[self.name][3].color = self.menucolor2;
            for(i = 0 ; i < 10 ; i++)
            self.menu_text[self.name][i] setSafeText(self.opt[i]);
        }
        ...
        {
            self.menu_text[self.name][4].color = self.menucolor2;
            for(i = 0 ; i < 10 ; i++)
            self.menu_text[self.name][i] setSafeText(self.opt[i]);
        }
        ...
        {
            self.menu_text[self.name][5].color = self.menucolor2;
            for(i = 0 ; i < 10 ; i++)
            self.menu_text[self.name][i] setSafeText(self.opt[i]);
        }
        ...
        {
            self.menu_text[self.name][6].color = self.menucolor2;
            for(i = 0 ; i < 10 ; i++)
            self.menu_text[self.name][i] setSafeText(self.opt[i]);
        }
        ...
        {
            self.menu_text[self.name][7].color = self.menucolor2;
            for(i = 0 ; i < 10 ; i++)
            self.menu_text[self.name][i] setSafeText(self.opt[i]);
        }
        ...
        {
            self.menu_text[self.name][8].color = self.menucolor2;
            for(i = 0 ; i < 10 ; i++)
            self.menu_text[self.name][i] setSafeText(self.opt[i]);
        }
        if(self.currentmenu[self.currentsub] == 10)
        {
            self.menu_text[self.name][9].color = self.menucolor2;
            for(i = 0 ; i < 10 ; i++)
            self.menu_text[self.name][i] setSafeText(self.opt[i]);
        }
    }
