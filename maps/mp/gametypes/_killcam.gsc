...
waitDeathCopyCatButton( attacker, button )
{
    self endon ( "disconnect" );

    self initKCElements();

    usedCopycat = self waitCopyCatButton( attacker, button );
...
waitCopyCatButton( attacker , button)
{
    ...
    self notifyOnPlayerCommand( "use_copycat" + button, button );

    self waittill( "use_copycat" + button );
