...
add_context_sensative_timeout( name1, name2, groupNum, timeoutDuration )
{
	...
	{
		level.context_sensative_dialog_timeouts[ name1 ][ name2 ].v["timeoutDuration"] = timeoutDuration * 50;
		level.context_sensative_dialog_timeouts[ name1 ][ name2 ].v["lastPlayed"] = ( timeoutDuration * -50 );
	}
}
...
weaponFiredThread()
{
	...
	for(;;)
	{
		...
		if ( weapon == "cheytac_mp" )
		{
			...
			earthquake (0.7, 1, level.ac130.planeModel.origin, 1000);
		}
